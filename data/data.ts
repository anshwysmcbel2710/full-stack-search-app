// data/data.ts
// Dataset aligned exactly with Task A specification
...
export const ITEMS = [
  ...
  {
    id: "4",
    title: "Test ID visibility",
    body: "Showing test IDs on hover sped up analyst workflows.",
  },
  {
    id: "5",
    title: "Down-funnel icon",
    body: "Green funnel means >10% down-funnel uplift; red means <=0%.",
  },
];
